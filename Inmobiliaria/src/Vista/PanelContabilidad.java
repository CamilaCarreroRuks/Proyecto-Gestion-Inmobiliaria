 ...
 */
public class PanelContabilidad extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        bGenerarComprobante = new javax.swing.JButton();
        ...
        jToolBar1.setPreferredSize(new java.awt.Dimension(370, 28));
        ...
        bGenerarComprobante.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        bGenerarComprobante.setText("Generar Comprobante");
        bGenerarComprobante.setToolTipText("");
        bGenerarComprobante.setFocusable(false);
        bGenerarComprobante.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        bGenerarComprobante.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        jToolBar1.add(bGenerarComprobante);
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Cliente", "Fecha", "Monto", "Concepto", "Tipo de Contabilidad", "Saldo"
            }
        ) {
        ...
        filtro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Todos", "Cliente", "Concepto", "Tipo de Contabilidad" }));
    ...
    public javax.swing.JButton bGenerarComprobante;
