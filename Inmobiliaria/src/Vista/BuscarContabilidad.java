 ...
 */
public class BuscarContabilidad extends javax.swing.JDialog {

    public BuscarContabilidad(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Cliente", "Fecha", "Monto", "Concepto", "Tipo de Contabilidad"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarContabilidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BuscarContabilidad dialog = new BuscarContabilidad(new javax.swing.JFrame(), true);
