 ...
 */
public class PanelTasacion extends javax.swing.JPanel {

    public PanelTasacion() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jToolBar1.setPreferredSize(new java.awt.Dimension(346, 28));
        ...
        bAgregarPropiedad.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        bAgregarPropiedad.setText("Agregar Propiedad");
        bAgregarPropiedad.setFocusable(false);
        bAgregarPropiedad.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        bAgregarPropiedad.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        jToolBar1.add(bAgregarPropiedad);
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Fecha", "Cliente", "Dirección", "Localidad", "Tipo de Propiedad", "Valor Construcción", "Valor Terreno", "Valor Total"
            }
        ) {
        ...
        filtro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Todos", "Fecha", "Cliente", "Dirección", "Localidad", "Tipo de Propiedad" }));
