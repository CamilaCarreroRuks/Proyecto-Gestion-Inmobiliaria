 ...
 */
public class ImprimirReporte extends javax.swing.JDialog {

    public ImprimirReporte(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        reporte = new Vista.Reportes.Reporte();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ImprimirReporte dialog = new ImprimirReporte(new javax.swing.JFrame(), true);
    ...
    public Vista.Reportes.Reporte reporte;
